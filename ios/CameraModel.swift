...
// @objc(CameraModel)
// class CameraModel: NSObject, AVCapturePhotoCaptureDelegate, RCTBridgeModule {
...
class CameraModel: NSObject, AVCapturePhotoCaptureDelegate {
    ...
    func startCamera(_ resolver: @escaping RCTPromiseResolveBlock,
        ...
        sessionQueue.async {
            do {
                try self.checkCameraAuthorization()
    ...
    private func checkCameraAuthorization() throws {
        ...
        case .notDetermined:
            ...
            if timeoutResult == .timedOut || !permissionGranted {
                throw NSError(domain: "CameraModel",
                              code: -5,
